...
var accordionParts = document.querySelectorAll('.main-footer__button-wrapper');
var acoordionContent = document.querySelectorAll('.main-footer__accordion-content');
var breakpoint = window.matchMedia('(min-width:768px)');
var accordionButtons = document.querySelectorAll('.main-footer__button');
    ...
    if (accordionParts) {
      ...
      var _loop = function _loop(i) {
        accordionParts[i].addEventListener('click', function (evt) {
          var content = evt.currentTarget.closest('section').querySelector('.main-footer__accordion-content');
          var button = evt.currentTarget.closest('section').querySelector('.main-footer__button');
...
var submitButtons = document.querySelectorAll('button[data-form-submit]');
...
telInputs.forEach(function (element) {
...
submitButtons.forEach(function (submitButton) {
  var nameModalError = submitButton.closest('form').querySelector('div[data-error-message="name"]');
  var nameModalInput = submitButton.closest('form').querySelector('input[name="name"]');
  var telModalError = submitButton.closest('form').querySelector('div[data-error-message="tel"]');
  var telModalInput = submitButton.closest('form').querySelector('input[type="tel"]');
  var checkboxModal = submitButton.closest('form').querySelector('input[type="checkbox"]');
  var checkboxModalMark = submitButton.closest('form').querySelector('.custom-checkbox__mark');
  submitButton.addEventListener('click', function () {
    var telValue = telModalInput.value.replace(/\D+/g, '');
    var nameValue = nameModalInput.value.replace(/[\-\s]/g, '');
...
/* harmony import */ var _window_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./window.js */ "./js/window.js");
...
var focisInput = document.querySelector('#modal-name');
...
var scrollButton = document.querySelector('.main-section__button');
var formSection = document.querySelector('.form-section__wrapper');
var productSectionTitle = document.querySelector('.products__text');
var breakpoint = window.matchMedia('(min-width:768px)');
var mobileText = document.querySelector('[data-text-modile-hide]');
var hideText = document.querySelectorAll('[data-hide-text]');
var moreButton = document.querySelector('.company-info__button');
var hideTextContent = function hideTextContent(action) {
  hideText.forEach(function (item) {
